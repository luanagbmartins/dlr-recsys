...
#A2Fair
python -m luigi --module train TrainRS --dataset-version movie_lens_100k --train-version movie_lens_100k_fair --reward-version combining --srm-version combining --srm-size 3 --local-scheduler
python -m luigi --module train TrainRS --dataset-version movie_lens_100k --train-version movie_lens_100k_fair --reward-version combining --srm-version combining --srm-size 3 --local-scheduler
python -m luigi --module train TrainRS --dataset-version movie_lens_100k --train-version movie_lens_100k_fair --reward-version combining --srm-version combining --srm-size 3 --local-scheduler
python -m luigi --module train TrainRS --dataset-version movie_lens_100k --train-version movie_lens_100k_fair --reward-version combining --srm-version combining --srm-size 3 --local-scheduler
python -m luigi --module train TrainRS --dataset-version movie_lens_100k --train-version movie_lens_100k_fair --reward-version combining --srm-version combining --srm-size 3 --local-scheduler
...
python -m luigi --module train TrainRS --dataset-version movie_lens_100k --train-version movie_lens_100k_fair --reward-version combining --srm-version paper --srm-size 2 --local-scheduler
python -m luigi --module train TrainRS --dataset-version movie_lens_100k --train-version movie_lens_100k_fair --reward-version combining --srm-version paper --srm-size 2 --local-scheduler
python -m luigi --module train TrainRS --dataset-version movie_lens_100k --train-version movie_lens_100k_fair --reward-version combining --srm-version paper --srm-size 2 --local-scheduler
python -m luigi --module train TrainRS --dataset-version movie_lens_100k --train-version movie_lens_100k_fair --reward-version combining --srm-version paper --srm-size 2 --local-scheduler
python -m luigi --module train TrainRS --dataset-version movie_lens_100k --train-version movie_lens_100k_fair --reward-version combining --srm-version paper --srm-size 2 --local-scheduler
...
python -m luigi --module train TrainRS --dataset-version movie_lens_100k --train-version movie_lens_100k_fair --reward-version paper --srm-version combining --srm-size 3 --local-scheduler
python -m luigi --module train TrainRS --dataset-version movie_lens_100k --train-version movie_lens_100k_fair --reward-version paper --srm-version combining --srm-size 3 --local-scheduler
python -m luigi --module train TrainRS --dataset-version movie_lens_100k --train-version movie_lens_100k_fair --reward-version paper --srm-version combining --srm-size 3 --local-scheduler
python -m luigi --module train TrainRS --dataset-version movie_lens_100k --train-version movie_lens_100k_fair --reward-version paper --srm-version combining --srm-size 3 --local-scheduler
python -m luigi --module train TrainRS --dataset-version movie_lens_100k --train-version movie_lens_100k_fair --reward-version paper --srm-version combining --srm-size 3 --local-scheduler
